...
const DEFAULT_PREFIX = `You are MYTHOS-CLI, a powerful agentic coding tool.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are MYTHOS-CLI, a powerful agentic coding tool, running within the Claude Agent SDK.`
